...
# Open PNG device
 png("g_plot_01.png", width=480, height=480)

# Create Histogram in red with label for x-achsis and title
 hist(data$Global_active_power, col="red",
      xlab="Global Activ Power (kilowatts)", main="Histogramm of Global Active Power")
